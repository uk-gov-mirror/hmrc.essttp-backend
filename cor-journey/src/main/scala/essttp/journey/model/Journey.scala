...
object JourneyStage {
  ...
  sealed trait BeforeAssessmentCategoryDetermined extends JourneyStage

  sealed trait AfterAssessmentCategoryDetermined extends JourneyStage {
    def assessmentCategory: AssessmentCategory
  }
...
object Journey {
  ...
  final case class Started(
    ...
    override val redirectToLegacySaService: Option[Boolean]
        ...
        BeforeAssessmentCategoryDetermined,
  ...
  /** [[Journey]] after EligibilityCheck
    */
  final case class AssessmentCategoryDetermined(
    override val _id:                       JourneyId,
    override val origin:                    Origin,
    override val createdOn:                 Instant,
    override val sjRequest:                 SjRequest,
    ...
    override val taxId:                     TaxId,
    override val eligibilityCheckResult:    EligibilityCheckResult,
    override val assessmentCategory:        AssessmentCategory,
    override val pegaCaseId:                Option[PegaCaseId],
    override val redirectToLegacySaService: Option[Boolean]
  ) extends Journey,
        AfterComputedTaxId,
        AfterEligibilityChecked,
        AfterAssessmentCategoryDetermined,
        BeforeWhyCannotPayInFullAnswers,
        BeforeAnsweredCanPayUpfront,
        BeforeEnteredUpfrontPaymentAmount,
        BeforeUpfrontPaymentAnswers,
